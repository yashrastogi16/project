...
breakfast_start = datetime.time(5,00,00,0000)
breakfast_end = datetime.time(6,00,00,0000)
lunch_start = datetime.time(11,00,00,0000)
lunch_end = datetime.time(13,00,00,0000)
dinner_start = datetime.time(18,00,00,0000)
dinner_end = datetime.time(19,30,00,0000)
